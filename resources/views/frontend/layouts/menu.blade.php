    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-4">
                <div class="logo ">
                    <a href="{{ route('home') }}"><img src="{{ asset('frontend/assets/img/oases/oases-logo.png') }}" alt="logo"></a>
                </div>
            </div>
                ...
                <nav>
                    <div class="mainmenu text-right">
                        <ul id="nav" class="menu">
                            <li><a href="{{ url('') }}#slider-section">@lang('menu.index')</a></li>
                            <li class="dropdown current-menu-item current-menu-has-children">
                                <a href="javascript:;">@lang('menu.about')</a>
                                <ul class="dropdown-menu">
                                    <li><a href="{{ route('home') }}#work_area">@lang('menu.project')</a></li>
                            ...
                            <li class="dropdown current-menu-item current-menu-has-children">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="@if(config('app.locale') == 'zh'){{ url('/frontend/assets/OASES_CHAIN_BUSINESS_WHITE_PAPER').'_'.config('app.locale').'.pdf' }}@else javascript:; @endif" onclick="javascript:window.location.href=this.href;">@lang('menu.whitebook')</a></li>

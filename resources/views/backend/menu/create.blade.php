...
<div class="portlet light bordered form-fit">
    ...
    <div class="portlet-body form">
        ...
        <form action="{{ route('admin.menu.store') }}" class="form-horizontal form-bordered form-row-stripped" method="post">
        	{{ csrf_field() }}
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="name" placeholder="请填写菜单名称" class="form-control" datatype="*" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="route" value="{{old('route')}}" placeholder="请填写菜单路由" class="form-control" datatype="*">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="icon" value="{{old('icon')}}" placeholder="请填写菜单图标" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="permission" value="{{old('permission')}}" placeholder="请填写菜单权限" class="form-control" datatype="*">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" rows="3" name="description" placeholder="请填写菜单描述">{{old('description')}}</textarea>
                    </div>
                </div>
            </div>

...
class WechatService extends Service
{
	...
	public function index()
	{
		$html = $this->builder->columns([
		    ...
		    ['data' => 'name', 'name' => 'name', 'title' => '微信名'],
		])->ajax([
			'url' => route('admin.wechat.index'),
		    'type' => 'GET',
	...
	{
		return DataTables::of($this->wechatRepo->all())
				->editColumn('avatar', function ($wechat) {
					return "<img height='80' src='".$wechat->avatar."' />";
				})
				->addColumn('action', 'backend.wechat.datatable')
				->toJson();
	}
